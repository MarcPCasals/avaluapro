...
const tdahSections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Ampliar el temps en activitats o proves quan calgui.',
...
export const DIAGNOSIS_LIBRARY = {
  dyslexia: {
    ...
    summary: [
      ...
      'Destacar el més important en negreta.',
      'Permetre respostes orals, visuals o guiades quan l’escriptura interfereixi.',
    ],
    description:
  ...
  dyscalculia: {
    ...
    summary: [
      ...
      'Evitar l’aglomeració de números, dades o instruccions.',
      'Permetre respostes visuals, gràfiques o manipulatives.',
      'Permetre calculadora, taules o fórmules si l’objectiu no és memoritzar el càlcul.',
    ],
    description:
  ...
  tea: {
    ...
    summary: [
      ...
      'Regular estímuls sensorials i preveure espais de calma.',
      'Definir rols clars en activitats cooperatives.',
    ],
    description:
  ...
  'high-capacity': {
    ...
    summary: [
      ...
      'Afavorir pensament crític, creatiu i divergent.',
      'Reduir tasques repetitives quan no aporten aprenentatge nou.',
      'Permetre productes finals variats i projectes personals.',
      'Acompanyar perfeccionisme, frustració i dimensió social.',
    ],
    description:
