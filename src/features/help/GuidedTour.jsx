...
const ownDataTourSteps = [
  ...
  {
    target: 'guide-button',
    title: '29. Ajuda i guies parcials',
    text: 'Aquest botó obre l’ajuda. Allà tens un resum escrit de les funcions bàsiques i pots reiniciar només la guia demo, la guia amb dades pròpies o la guia de tutoria. La guia demo avisa abans perquè reinicia les dades fictícies.',
    action: 'Clica el botó “?” quan vulguis recuperar una guia o revisar una explicació.',
    mode: 'evaluation',
    placement: 'left',
    final: true,
    requiresClassStudents: true,
