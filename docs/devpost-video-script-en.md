...
| 1:10-1:32 | Show the title, `0 identificadors directes`, the four summary cards and the excluded-fields list. | **The privacy gate removes direct identifiers, raw text and diagnosis labels. It keeps only concrete classroom support needs, such as shorter instructions or additional processing time, without naming their clinical origin.** |
