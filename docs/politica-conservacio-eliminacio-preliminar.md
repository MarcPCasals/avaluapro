...
| Sociometria bruta, tokens i enllaços | Enllaç durant 24 hores; resposta fins a sincronització | Eliminar immediatament després de sincronitzar; límit màxim provisional de 7 dies després de caducar | Destruir | Eliminació manual; purga automàtica pendent |
